...
class RBACModel:
    ...
    def define_tables(db: DAL):
        ...
        db.define_table(
            ...
            Field('scope', type='string', required=True, length=20,
    ...
    @staticmethod
    def assign_role(db: DAL, user_id: int, role_name: str,
    ...
    @staticmethod
    def revoke_role(db: DAL, user_id: int, role_name: str,
                    resource_id: Optional[int] = None):
    ...
    @staticmethod
    def has_permission(db: DAL, user_id: int, permission: str,
