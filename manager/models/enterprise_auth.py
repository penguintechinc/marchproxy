...
class SAMLAuthenticator:
    ...
    def process_response(
        self, saml_response: str, request_id: str = None
    ...
    def create_logout_request(self, name_id: str, session_index: str) -> str:
        ...
        req_id, info = self.saml_client.global_logout(
            name_id=name_id, session_index=session_index, binding=BINDING_HTTP_REDIRECT
        )
    ...
    def process_scim_user(db: DAL, scim_data: Dict[str, Any], provider_name: str) -> Optional[int]:
        ...
        if scim_user:
            ...
            scim_user.update_record(
                scim_data=scim_data, is_active=is_active, last_sync=datetime.utcnow()
            )
...
class EnterpriseAuthManager:
    ...
    def provision_user_from_external(
        self, provider_name: str, external_data: Dict[str, Any]
    ) -> Optional[int]:
