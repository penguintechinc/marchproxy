...
from sqlalchemy import (
    ...
    Float, BigInteger, ForeignKey, JSON, Index, UniqueConstraint,
    event
)
...
class User(Base):
    ...
    clusters_created = relationship('Cluster', back_populates='created_by_user', foreign_keys='Cluster.created_by')
    user_cluster_assignments = relationship('UserClusterAssignment', back_populates='user', cascade='all, delete-orphan')
    services_created = relationship('Service', back_populates='created_by_user', foreign_keys='Service.created_by')
    user_service_assignments = relationship('UserServiceAssignment', back_populates='user', cascade='all, delete-orphan')
    mappings_created = relationship('Mapping', back_populates='created_by_user', foreign_keys='Mapping.created_by')
    certificates_created = relationship('Certificate', back_populates='created_by_user', foreign_keys='Certificate.created_by')
    block_rules_created = relationship('BlockRule', back_populates='created_by_user', foreign_keys='BlockRule.created_by')
...
class Cluster(Base):
    ...
    proxy_servers = relationship('ProxyServer', back_populates='cluster', cascade='all, delete-orphan')
    ...
    user_cluster_assignments = relationship('UserClusterAssignment', back_populates='cluster', cascade='all, delete-orphan')
    block_rules = relationship('BlockRule', back_populates='cluster', cascade='all, delete-orphan')
    xdp_rate_limits = relationship('XDPRateLimit', back_populates='cluster', cascade='all, delete-orphan')
    tls_proxy_cas = relationship('TLSProxyCA', back_populates='cluster', cascade='all, delete-orphan')
...
class ProxyServer(Base):
    ...
    proxy_metrics = relationship('ProxyMetric', back_populates='proxy_server', cascade='all, delete-orphan')
    xdp_rate_limit_stats = relationship('XDPRateLimitStats', back_populates='proxy', cascade='all, delete-orphan')
...
class Service(Base):
    ...
    created_by_user = relationship('User', back_populates='services_created', foreign_keys=[created_by])
    user_service_assignments = relationship('UserServiceAssignment', back_populates='service', cascade='all, delete-orphan')
...
class Mapping(Base):
    ...
    created_by_user = relationship('User', back_populates='mappings_created', foreign_keys=[created_by])
...
class TLSProxyCA(Base):
    ...
    created_by_user = relationship('User', back_populates='tls_proxy_cas', foreign_keys=[created_by])
    tls_proxy_configs = relationship('TLSProxyConfig', back_populates='ca', cascade='all, delete-orphan')
...
class BlockRule(Base):
    ...
    created_by_user = relationship('User', back_populates='block_rules_created', foreign_keys=[created_by])
...
class BlockRuleSync(Base):
    ...
    __table_args__ = (
        Index('idx_block_rule_sync_proxy_id', 'proxy_id'),
    )
...
class XDPRateLimit(Base):
    ...
    created_by_user = relationship('User', back_populates='xdp_rate_limits', foreign_keys=[created_by])
    stats = relationship('XDPRateLimitStats', back_populates='rate_limit', cascade='all, delete-orphan')
    whitelist = relationship('XDPRateLimitWhitelist', back_populates='rate_limit', cascade='all, delete-orphan')
...
class XDPRateLimitWhitelist(Base):
    ...
    created_by_user = relationship('User', back_populates='xdp_whitelist', foreign_keys=[created_by])
