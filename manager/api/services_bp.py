...
from models.service import (
    ServiceModel, UserServiceAssignmentModel,
    CreateServiceRequest, UpdateServiceRequest, ServiceResponse,
    ServiceAuthResponse, AssignUserToServiceRequest, SetServiceAuthRequest,
...
async def set_service_auth(service_id, user_data):
    ...
    try:
        ...
        return jsonify({"error": "Failed to set authentication", "details": str(e)}), 500
