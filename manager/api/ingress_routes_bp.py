    ...
    if request.method == 'GET':
        ...
        async def get_routes(user_data):
            ...
            try:
                ...
                result = []
                for route in routes:
                    result.append(IngressRouteResponse(
                        id=route.id,
                        name=route.name,
                ...
                return jsonify({"error": "Failed to fetch routes", "details": str(e)}), 500
        ...
        async def create_route_handler(user_data):
            ...
            try:
                ...
                if not dest_service:
                    return jsonify({"error": "Destination service not found in cluster"}), 404
...
async def update_route_status(route_id, user_data):
    ...
    try:
        ...
        return jsonify({"error": "Failed to update route status", "details": str(e)}), 500
