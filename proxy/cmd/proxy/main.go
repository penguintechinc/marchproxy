...
import (
	...
	"github.com/penguintech/marchproxy/internal/ebpf"
...
func main() {
	var rootCmd = &cobra.Command{
		Use:   "marchproxy",
		Short: "MarchProxy - Enterprise-grade proxy server",
		Long: `MarchProxy is a high-performance proxy server with eBPF acceleration.
...
func runProxy(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("Starting MarchProxy %s\n", version)
...
func startAdminServer(port int, metrics *ProxyMetrics, ebpfMgr *ebpf.Manager) error {
