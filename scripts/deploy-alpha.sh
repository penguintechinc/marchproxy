#!/usr/bin/env bash
# =============================================================================
# MarchProxy Alpha Deployment Script
...
#   NAMESPACE             Target namespace (default: marchproxy-alpha)
#   APP_HOST              Application hostname (default: marchproxy.localhost.local)
#
# =============================================================================
...
readonly APP_NAME="${APP_NAME:-marchproxy}"
readonly KUBE_CONTEXT="${KUBE_CONTEXT:-local-alpha}"
readonly NAMESPACE="${NAMESPACE:-marchproxy-alpha}"
readonly APP_HOST="${APP_HOST:-marchproxy.localhost.local}"
